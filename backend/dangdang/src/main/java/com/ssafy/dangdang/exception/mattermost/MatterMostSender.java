package com.ssafy.dangdang.exception.mattermost;
...
import static com.ssafy.dangdang.exception.mattermost.MatterMostMessageDto.*;
...
public class MatterMostSender {
    ...
    public void sendMessage(Exception excpetion, String uri, String params) {
        ...
        try {
            Attachment attachment = MatterMostMessageDto.Attachment.builder()
