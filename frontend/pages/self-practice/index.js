  ...
  return (
    <div className="container">
      ...
      <div className={styles.txt}>
        <h1># 혼자연습한당</h1>
        <div>
          연습하고 싶은 질문을 골라서,<br></br>내 마음에 들 때까지 무한반복 1인
          연습모드!
        </div>
      </div>
      ...
      <div className={styles.explain}>
        ...
        <div className={styles.component1}>
          ...
          <pre className={styles.explainContents}>
            <p>
              기본 질문을 선택하시면, 즐겨찾기로 많이 등록된 질문들 5개로 빠르게{" "}
              <strong>STEP3</strong>로 넘어갈 수 있습니다.
              <br />
              질문 선택을 고르시면, 다양한 질문을 직접 뽑아서 면접연습을 하실 수
              있습니다.
            </p>
          </pre>
        </div>
        <div className={styles.component1}>
          ...
          <pre className={styles.explainContents}>
            <p>
              ...
              <br />
              로그인을 하시면, 즐겨찾기 등록한 질문 리스트와, 작성한 질문
              리스트에서도 선택할 수 있습니다.
            </p>
          </pre>
        </div>
        ...
        <div className={styles.component1}>
          ...
          <pre className={styles.explainContents}>
            <p>
              질문리스트의 질문을 TTS로 읽어주지만, MODE1을 통해 질문을 보실 수
              있습니다.
            </p>
          </pre>
        </div>
        ...
        <div className={styles.component1}>
          ...
          <pre className={styles.explainContents}>
            <p>
              저장한 질문에 대한 영상을 재생하여, 자신의 면접모습을 확인할 수
              있습니다.
            </p>
          </pre>
        </div>
